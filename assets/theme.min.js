!function(t, e, i, n, s, o, a, r, d, h, l, c, u, m) {
    function p() {
        this.registered = {},
        this.instances = [],
        this.extensions = {
    ...
    function x(e, i) {
        this.$element = t(e),
        this.$slides = t(gt.slides, this.$element),
        this.config = t.extend({}, _t, i),
        this._setCurrentSlide(t(gt.activeSlide, this.$element)),
    ...
    var F = {
      ...
      , M = {
        ...
        showSocialSharing: function() {
            t(F.socialSharing, this.$container).addClass(D.socialSharingAction),
        ...
        hideSocialSharing: function() {
            t(F.socialSharing, this.$container).removeClass(D.socialSharingAction),
    ...
    A.register("Customer Addresses Template", "template-addresses", {
        onLoad: function(e) {
            ...
            0 !== t("div.errors", o).length && o.removeClass(V.newAddressHide),
            a.each(function() {
        ...
        _onDeleteAddressClick: function(e) {
            ...
            t(N.newAddressContainer, this.$container).removeClass(V.newAddressHide)))
        }
    });
    var R = {
      ...
      , Y = {
        init: function() {
            ...
            B.promiseStylesheet().then(function() {
                ...
                t(K.cardListSub, this.$container).prepareTransition().addClass(U.cardListSubLoaded)
            }
            .bind(this))
        },
        _onResize: function() {
        ...
        _revealCard: function(e) {
            ...
            requestAnimationFrame(i.addClass.bind(i, U.cardReveal))
        },
        _promiseRevealReady: function(e) {
            return t.Deferred(function(i) {
                ...
                var s = t(e);
                t("html").hasClass("is-ios") && Shopify.designMode ? (t(e).addClass(U.cardReveal),
        ...
        _matchRowHeights: function(e, i) {
            ...
            for (var d = e.find(o).parent(), h = 0; h < d.length; h++)
                ...
                (s = t(document.body).hasClass(U.searchTemplate) && a ? t(d[h]).find(K.cardWrapper).outerHeight() : t(d[h]).find(K.cardWrapper).outerWidth() + t(d[h]).find(K.cardInfo).outerHeight()) > n && (n = s);
    ...
    var X = {
      ...
      , it = {
        ...
        _createItemList: function(e) {
            return t.map(e.items, function(e) {
                var i = this.$itemTemplate.clone().removeClass(et.cartTemplate)
                  ...
                  , o = this._createItemPrice(e.original_price, e.final_price)
                  , a = this._createItemPrice(e.original_line_price, e.final_line_price);
        ...
        _createItemPrice: function(t, e) {
            return t !== e ? '<span class="visually-hidden">' + theme.strings.regularPrice + '</span><del class="cart-item__original-price">' + G.formatMoney(t, theme.moneyFormat) + '</del><span class="visually-hidden">' + theme.strings.salePrice + '</span><span class="order-discount cart-item__price">' + G.formatMoney(e, theme.moneyFormat) + "</span>" : '<span class="cart-item__original-price cart-item__price">' + G.formatMoney(t, theme.moneyFormat) + "</span>"
        },
    ...
    var lt = {
      ...
      , mt = {
        init: function() {
            ...
            this.on("submit", ut.productForm, this._addItemToCart.bind(this)),
            this.one("focus", ut.optionInputs, this._preloadVariantImages.bind(this)),
            this.on("change.variantController", ut.optionInputs, this.update.bind(this)),
            this.document().on("click", ut.ajaxCartToggle, this._resetAddToCartButton.bind(this)),
        ...
        _preloadVariantImages: function() {
            t(ut.variantImage, this.$container).addClass(ct.lazyPreload)
        },
        ...
        _updatedContainer: function(e) {
            var i = this.$container.clone();
            return t(ut.masterSelect, i).val(e.id),
        ...
        _updateCartButtonState: function(e, i) {
            ...
            e.available ? t(ut.shopifyPaymentButton, i).show() : t(ut.shopifyPaymentButton, i).hide(),
            t(ut.submitButton, i).prop("disabled", !e.available).attr("aria-label", n),
            t(ut.submitButtonPrimaryText, i).text(n)
        },
        _updateProductPrices: function(e, i) {
            var n = e.price
              , s = e.compare_at_price;
            t(ut.regularPrice, i).html(G.formatMoney(n, theme.moneyFormat)),
            t(ut.compareAtPrice, i).html(G.formatMoney(s, theme.moneyFormat)),
            t(ut.productPrice, i).toggleClass(ct.productPriceSale, s > n)
        },
        ...
        _toggleVariantImageHide: function(e, i) {
            if (e.featured_image || this.product.featured_image) {
                var n = e.featured_image || this.product.featured_image.id
                  , s = n && n.id;
                t(ut.variantImageToggleHide, i).filter('[data-id="' + s + '"]').removeClass(ct.hide).siblings().addClass(ct.hide)
            }
        },
        _addItemToCart: function(e) {
            if (Q.isInstance("cart-drawer")) {
                ...
                i.hasClass(ct.ajaxCartToggle) || X.addItemFromForm(n).then(this._transitionAddToCartButton.bind(this, n)).catch(this._onAddItemFail.bind(this)).always(function() {
        ...
        _onAddItemFail: function(e) {
            ...
            i.addClass(ct.productNotificationError).removeClass(ct.productNotificationSuccess).html(n).attr("role", "alert"),
        ...
        _transitionAddToCartButton: function(e) {
            ...
            return n.addClass([ct.buttonTransition, ct.ajaxCartToggle].join(" ")).attr("aria-label", theme.strings.viewCart),
            s.attr("aria-hidden", !0),
            o.attr("aria-hidden", !1),
            i.removeClass(ct.productNotificationError).addClass(ct.productNotificationSuccess).text(theme.strings.addItemSuccess).attr("role", "alert"),
        ...
        _resetAddToCartButton: function(e) {
            ...
            var i = t(ut.notification, e)
              ...
              , s = t(ut.submitButtonPrimaryText, n)
              , o = t(ut.submitButtonSecondaryText, n);
            n.removeClass([ct.buttonTransition, ct.ajaxCartToggle].join(" ")).attr("aria-label", theme.strings.addToCart),
            s.attr("aria-hidden", !1),
            o.attr("aria-hidden", !0),
            i.removeClass(ct.productNotificationError).removeClass(ct.productNotificationSuccess).text("").attr("role", "")
        },
    ...
    x.prototype = t.extend({}, x.prototype, {
        ...
        nextSlide: function() {
            return this._triggerEvent([vt.nextSlide, vt.transitionStart]),
        ...
        previousSlide: function() {
            return this._triggerEvent([vt.prevSlide, vt.transitionStart]),
        ...
        _promiseNextSlide: function() {
            return requestAnimationFrame(function() {
                this.$nextSlide.addClass(ft.nextSlide),
                requestAnimationFrame(function() {
                    this.$slides.removeAttr("style"),
                    this.$nextSlide.removeClass(ft.nextSlide).addClass(ft.activeSlide).addClass(ft.transitioningSlide),
                    this.$currentSlide.removeClass(ft.activeSlide).addClass(ft.previousSlide).addClass(ft.transitioningSlide)
                }
                .bind(this))
            }
            .bind(this)),
        ...
        _promisePrevSlide: function() {
            return requestAnimationFrame(function() {
                this.$previousSlide.addClass(ft.previousSlide),
                requestAnimationFrame(function() {
                    this.$slides.removeAttr("style"),
                    this.$previousSlide.removeClass(ft.previousSlide).addClass(ft.activeSlide).addClass(ft.transitioningSlide),
                    this.$currentSlide.removeClass(ft.activeSlide).addClass(ft.nextSlide).addClass(ft.transitioningSlide)
                }
                .bind(this))
            }
            .bind(this)),
        ...
        _promiseSlide: function(e) {
            ...
            e.addClass(ft.activeSlide).siblings().removeClass(ft.activeSlide),
        ...
        _promiseSlideTransitionEnd: function() {
            return t.Deferred(function(t) {
                this.$currentSlide.one("transitionend", function() {
                    this.$slides.removeClass([ft.transitioningSlide, ft.nextSlide, ft.previousSlide].join(" ")),
                    t.resolve()
                }
                .bind(this))
            }
        ...
        _onTouchMove: function(t) {
            ...
            this.percentMoved > 0 ? (this.$previousSlide.addClass(ft.previousSlide),
            this.$nextSlide.removeClass(ft.nextSlide),
            this.$previousSlide.css({
                transform: "translateX(" + (this.percentMoved - 100) + "%)"
            })) : (this.$previousSlide.removeClass(ft.previousSlide),
            this.$nextSlide.addClass(ft.nextSlide),
            this.$nextSlide.css({
        ...
        _onTouchEnd: function() {
            ...
            this.$currentSlide.removeClass(ft.draggingSlide),
    ...
    var bt = {
      ...
      , wt = {
        initRevealSlider: function() {
            ...
            this.slider = new x(t(bt.slider, this.$container)),
            this.hammertime = new m(this.$container[0]),
            this.on("click", bt.slideNavButtons, this._onClickNavButton.bind(this)),
            this.on("click", bt.slidePreviousButton, this.slider.previousSlide.bind(this.slider)),
            this.on("click", bt.slideNextButton, this.slider.nextSlide.bind(this.slider)),
            this.on("click", bt.closeCoverButton, this.closeCover.bind(this)),
            this.on("click", bt.coverContent, this.openCover.bind(this)),
        ...
        openCover: function() {
            this.$container.addClass(St.coverOpen),
            this.coverIsOpen = !0,
            this.trigger("reveal_slider_open_cover")
        },
        closeCover: function() {
            this.$container.removeClass(St.coverOpen),
            this.coverIsOpen = !1,
        ...
        _changeBackgroundColor: function(e, i) {
            ...
            t(bt.slider, this.$container).css({
                backgroundColor: n
            })
        },
        ...
        _onPinch: function(e) {
            this.$coverTopBackground = this.$coverTopBackground || t(bt.coverTopBackground, this.$container),
            this.$coverBottomBackground = this.$coverBottomBackground || t(bt.coverBottomBackground, this.$container),
            this.$coverTitle = this.$coverTitle || t(bt.coverContent, this.$container),
        ...
        _onPinchEnd: function(t) {
            t.scale > 2 ? (this.$container.addClass(St.coverOpen),
            this.coverIsOpen = !0) : (this.$container.removeClass(St.coverOpen),
            this.coverIsOpen = !1),
            requestAnimationFrame(function() {
      ...
      , $t = {
        initSideScroller: function() {
            ...
            this.$slides = t(yt.slides, this.$container),
            this.$slidesContainer = t(yt.slidesContainer, this.$container),
            this.sideScroller = !0,
        ...
        _setCoverPosition: function(t) {
            if (this.coverPosition !== t)
                switch (t) {
                case "top":
                    this.$container.removeClass([Ct.coverBottom, Ct.coverFixed].join(" ")),
                    this.trigger("side_scroller_position_top");
                    break;
                case "fixed":
                    this.$container.removeClass(Ct.coverBottom).addClass(Ct.coverFixed),
                    this.trigger("side_scroller_position_fixed");
                    break;
                case "bottom":
                    this.$container.removeClass(Ct.coverFixed).addClass(Ct.coverBottom),
    ...
    Q.register("footer", {
        onLoad: function() {
            ...
            t(document.body).addClass(kt.footerParallax),
            B.promiseStylesheet().then(this._setParallax.bind(this)))
        },
        onUnload: function() {
            t(document.body).removeClass(kt.footerParallax),
            t(xt.contentForLayout).css("margin-bottom", "")
        },
        _setParallax: function() {
            this.height = this.$container.innerHeight(),
            t(xt.contentForLayout).css("margin-bottom", this.height)
        },
        _handleDrawerOpenState: function() {
            if (document.body.scrollHeight - window.innerHeight == 0)
                ...
                t(xt.footerCover).css("height", e).show()
            }
        },
        _resetDrawerOpenState: function() {
            this.$container.css("margin-bottom", ""),
            t(xt.footerCover).hide()
        }
    });
    var Tt = {
        skipLink: ".skip-link",
    ...
    Q.register("header-section", {
        onLoad: function() {
            ...
            B.disableTabbingOfChildren(Tt.navigation),
            t(Tt.navigationButton).one("click", this._toggleNavigationDisplay.bind(this)).one("click", this._setSublinksMaxHeight.bind(this)),
            t(Tt.navigationExpandSublinks, e).on("click", this._toggleNavigationSublinks.bind(this)),
            t(Tt.announcementBarClose, e).on("click", this._closeAnnouncementBar.bind(this)),
            t("html").hasClass("is-ios") && Shopify.designMode ? t(Tt.siteHeader).removeClass(At.headerHomepage).removeClass(At.headerTransparent) : t(document).on("scroll" + this.namespace, n(this._toggleHeaderPosition.bind(this), 200)),
        ...
        _setupAnnouncementBar: function() {
            ...
            if (e.length && (!B.isSessionStorageSupported() || !sessionStorage.getItem("announcement-bar-hidden"))) {
                ...
                requestAnimationFrame(function() {
                    ...
                    i.css("margin-top", "-" + e.outerHeight() + "px"),
                    requestAnimationFrame(function() {
        ...
        _closeAnnouncementBar: function(e) {
            ...
            !Shopify.designMode) {
                ...
                n.css("margin-top", "-" + i.outerHeight() + "px"),
                t(Tt.announcementBarClose).attr("aria-expanded", !1),
                B.isSessionStorageSupported() && sessionStorage.setItem("announcement-bar-hidden", !0),
                B.promiseTransitionEnd(n).then(function() {
                    i.remove(),
                    n.removeClass(At.siteHeaderWrapperTransitioning).css("margin-top", "")
                })
            }
        },
        ...
        _promiseHeaderSlideIn: function() {
            ...
            t(Tt.siteHeaderWrapper).css("transform", "translateY(-100%)"),
            requestAnimationFrame(function() {
            ...
            B.promiseTransitionEnd(t(Tt.siteHeaderWrapper)).then(function() {
                ...
                t(Tt.siteHeaderWrapper).attr("style", "")
            }
            .bind(this))
        },
        ...
        showNavigation: function() {
            ...
            B.enableTabbingOfChildren(Tt.navigation),
            t(Tt.navigation).attr("aria-hidden", !1),
            this.promiseChain = this.promiseChain.then(this._promiseNavTransition.bind(this, !0)).then(this._promiseNavItemsTransition.bind(this, t(Tt.navAnimateElements, this.$container).toArray(), !0)).then(function() {
                t(document).on("keyup" + this.namespace, this._closeOnEscape.bind(this)),
                t(Tt.navigationButton).attr("aria-expanded", !0).off().one("click", this._toggleNavigationDisplay.bind(this))
            }
            .bind(this))),
        ...
        hideNavigation: function() {
            if (t(document.body).hasClass(At.navigationOpen)) {
                ...
                s.removeTrapFocus(),
                B.disableTabbingOfChildren(Tt.navigation),
                t(Tt.navigation).attr("aria-hidden", !0),
                ...
                this.promiseChain = this.promiseChain.then(this._promiseNavItemsTransition.bind(this, e.toArray().reverse(), !1)).then(this._promiseNavTransition.bind(this, !1)).then(function() {
                    ...
                    t(Tt.navigationButton).off().one("click", this._toggleNavigationDisplay.bind(this)).attr("aria-expanded", !1).focus()
                }
                .bind(this))
            }
        ...
        _adjustNavigationPadding: function() {
            this.headerHeight = t(Tt.siteHeader).height(),
            t(Tt.navigation, this.$container).css({
        ...
        _promiseNavTransition: function(e) {
            ...
            B.promiseTransitionEnd(t(Tt.navigation, this.$container)).then(function() {
        ...
        _toggleNavigationSublinks: function(e) {
            ...
            n.siblings(Tt.navigationHasSublinks).addClass(At.navigationHasSublinksCollapsed).children(Tt.navigationExpandSublinks).attr("aria-expanded", !1),
            this._setMaxHeight(n.siblings(Tt.navigationHasSublinks), ""),
        ...
        _toggleSubNavigationElementHeight: function(t) {
            ...
            if (e.hasClass(At.navigationHasSublinksCollapsed))
                ...
                if (e.hasClass(Tt.navigationSublink))
    ...
    var It, Ft = {
        ...
        promiseAPI: function(e) {
            return e = e || "",
            void 0 === It && (It = t.getScript("https://maps.googleapis.com/maps/api/js?key=" + e)),
            It.then(function() {
                return t.Deferred(function(t) {
                    window.google && window.google.maps || t.reject(Ft.apiLoadError),
    ...
    Q.register("map", {
        onLoad: function() {
            ...
            this.$map = t(Mt.map, this.$container),
            ...
            "string" == typeof this.key && "" !== this.key) {
                ...
                .bind(this)).catch(function(e) {
                    this.$container.addClass(Ht.mapError),
                    Shopify.designMode && t(Mt.mapError, this.$container).html(e).css("display", "inline-block")
                }
                .bind(this))
            }
        }
    ...
    Q.register("newsletter", {
        onLoad: function() {
            t("html").hasClass("is-ios") && Shopify.designMode && t(Lt.inputGroup, this.$container).addClass("has-animated"),
            this.$container.on("click", Lt.submitButton, this._checkEmail.bind(this))
        },
        _checkEmail: function() {
            var e, i = Lt.emailField + this.$container.data("section-id"), n = t(i, this.$container), s = t(Lt.newsletterMessage, this.$container), o = n[0].value, a = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            if ("" === o ? e = Ot.blankError : a.test(o) || (e = Ot.invalidError),
            void 0 !== e)
    ...
    var Nt = {
      ...
      , Rt = {
        init: function() {
            this.$productSlideshow = t(Vt.productSlideshow, this.$container),
            0 !== this.$productSlideshow.length && (t(Vt.productSlideshowOpen).on("click", this._onImageClick.bind(this)),
            this.$productSlideshow.appendTo(document.body),
            this.slideCount = t(Vt.productSlideshowSlide, this.$productSlideshow).length,
            this.slideCount > 1 && (this.slider = new x(t(Vt.slider, this.$productSlideshow))))
        },
        showSlideshow: function() {
            return this.trigger("product_slideshow_show"),
            this.$slideshowOpenFocus = t(document.activeElement),
            t(Vt.productSlideshowImage, this.$productSlideshow).addClass(Nt.lazypreload),
            Q.getInstances("header-section").then(function(t) {
                t[0].scrollHandler = !1,
                ...
                this.$productSlideshow.addClass(Nt.showProductSlideshow).attr("aria-hidden", !1),
                B.disableScrollBody(),
        ...
        hideSlideshow: function() {
            ...
            Q.getInstances("header-section").then(function(t) {
                ...
                this.$productSlideshow.removeClass(Nt.showProductSlideshow).attr("aria-hidden", !0),
        ...
        _assignEventHandlers: function() {
            ...
            this.$productSlideshow.on("slidetransitionend", this._setSlideIndicator.bind(this)).on("click", Vt.productSlideshowSelect, this._setSlide.bind(this)).one("click", Vt.productSlideshowClose, this.hideSlideshow.bind(this)).one("click", Vt.productSlideshowNext, this._nextSlide.bind(this)).one("click", Vt.productSlideshowPrevious, this._previousSlide.bind(this))
        },
    ...
    Q.register("product-template", {
        ...
        _handleFixedSideImage: function() {
            if ("fixed" === this.coverPosition) {
                ...
                t(Wt.productFormWrapper, this.$container).css({
        ...
        _resetFixedSideImage: function() {
            "fixed" === this.coverPosition && t(Wt.productFormWrapper, this.$container).css({
                transform: "",
                position: ""
            })
        },
        ...
        _setFormPosition: function() {
            if (!B.isMobile() && this.enableSticky) {
                ...
                requestAnimationFrame(function() {
                    ...
                    t(Wt.productFormWrapper).css("width", this.formWidth).removeClass(qt.productFormFixed).addClass(qt.productFormBottom)) : (this.coverPosition = "fixed",
                    t(Wt.productFormWrapper).css("width", this.formWidth).addClass(qt.productFormFixed).removeClass(qt.productFormBottom)) : (this.coverPosition = "top",
                    t(Wt.productFormWrapper).css("width", "").removeClass(qt.productFormFixed).removeClass(qt.productFormBottom))
                }
                .bind(this))
            }
        },
        _updateMeasurements: function() {
            var e = t(Wt.productFormWrapper)
              , i = t(Wt.productDescription).outerHeight(!0)
              , n = e.height();
    ...
    Q.register("quotes-section", {
        onLoad: function() {
            this.$container = t(this.container),
            this.$slider = t(jt.slider, this.$container),
            this.totalSlides = this.$slider.data("count"),
            this.speed = this.$slider.data("speed"),
            this.currentSlide = 0,
            this.$slider.find(jt.slide).length > 1 && this._startSlider()
        },
        ...
        _showSlide: function(t) {
            this.$slider.find(jt.slide).removeClass(zt.visible).end().find(t).addClass(zt.visible)
        },
        onBlockSelect: function(t) {
            clearInterval(this.interval);
            var e = this.$container.find(jt.slide + "--" + t.detail.blockId);
            this._showSlide(e)
        },
        onBlockDeselect: function() {
            this._startSlider()
    ...
    var Qt, Ut, Kt = {
        ...
        initDesktopSlideshow: function() {
            ...
            this.$slideshow = t(Xt.slideshow, this.$container),
            this.$slide = t(Xt.slide, this.$container),
            this.$buttons = t(Xt.buttons, this.$container),
            this.$button = t(Xt.button, this.$container),
            ...
            this.on("click" + this.desktopSlideshowNamespace, Xt.pauseButton, this._onPauseButton.bind(this)),
            this.on("click" + this.desktopSlideshowNamespace, Xt.label, this._onClickButton.bind(this)),
            ...
            B.promiseStylesheet().then(function() {
                ...
                this.$container.hasClass(Gt.centredCta) && this._setButtonStatus(0),
        ...
        _onPauseButton: function(e) {
            var i = this.$slide.eq(this.currentDesktopSlide)
              , n = t(e.target)
              , s = n.hasClass(Gt.paused)
              , o = this.$video.attr("data-block-id");
            n.toggleClass(Gt.paused, !s).attr({
                "aria-label": s ? n.data("label-pause") : n.data("label-play"),
                "aria-pressed": !s
            }),
            this.players[o] && (s ? this.players[o].playVideo() : this.players[o].pauseVideo()),
            i.toggleClass(Gt.videoPaused)
        },
        _onClickButton: function(e) {
            var i = t(e.target).closest(Xt.button);
            if (!i.hasClass(Gt.buttonActive)) {
                var n = i.index();
                this._setSlideDesktop(n),
                i.hasClass(Gt.buttonActive) || this._setButtonStatus(n)
            }
        },
        _setButtonStatus: function(t) {
            var e = this.$button.eq(t)
              , i = e.find(Xt.ctaText);
            this.$button.removeClass(Gt.buttonActive).find(Xt.label).attr("aria-expanded", !1),
            e.addClass(Gt.buttonActive).find(Xt.label).attr("aria-expanded", !0).focus(),
            this.$buttons.find(Xt.ctaText).empty().attr("aria-hidden", !0).removeClass(Gt.headingCtaActive).removeAttr("style"),
            i.parent().is("a") && this._showButtonContent(i),
            this.$button.find(Xt.cta).attr("tabindex", "-1"),
            e.hasClass(Gt.linkActive) && e.find(Xt.cta).attr("tabindex", "0")
        },
        _animateButtonFrame: function() {
            ...
            this.xPosition += t / Jt.easeIntensity,
        ...
        _showButtonContent: function(t) {
            ...
            requestAnimationFrame(function() {
                t.css({
                    minHeight: n + "px",
                    minWidth: i + "px"
                }).addClass(Gt.headingCtaTransitioning)
            }),
            B.promiseTransitionEnd(t).then(function() {
                t.html(e).removeClass(Gt.headingCtaTransitioning).addClass(Gt.headingCtaActive)
            })
        },
        ...
        _setSlideDesktop: function(t) {
            ...
            this.currentDesktopSlide !== t && (i.addClass(Gt.slideActive).attr("aria-hidden", !1),
            e.addClass(Gt.slideActiveTransitioning),
            B.promiseTransitionEnd(i).then(function() {
                e.removeClass(Gt.slideActive).removeClass(Gt.slideActiveTransitioning).attr("aria-hidden", !0)
            }),
        ...
        _loadVideo: function(t, e) {
            ...
            this._promiseVideo().then(function() {
                e.addClass(Gt.videoLoaded),
                e.find(Xt.pauseButton).prop("disabled", !1),
        ...
        _loadYoutubePlayer: function() {
            ...
            return Kt.promisePlayer(this.$video[0], {
                videoId: i,
                ratio: 16 / 9,
                playerVars: {
                    iv_load_policy: 3,
        ...
        _setButtonWrapperValues: function() {
            ...
            this.$button.find(Xt.ctaText).removeAttr("style data-previous-width data-previous-height data-new-width data-new-height"),
            this._setButtonsTranslateX(0)
        }
    }, te = {
        button: ".slideshow__button",
        ...
        initMobileSlideshow: function() {
            ...
            this.$navigationButtons = t(te.navigationButtons, this.$container),
            this.$ctaMultipleSlides = t(te.ctaMultipleSlides, this.$container),
            this.$ctaSingleSlide = t(te.ctaSingleSlide, this.$container),
            this.$indicatorDots = t(te.indicatorDots, this.$container),
            this.$mobileTextContainer = t(te.mobileTextContainer, this.$container),
            this.$mobileTextContent = t(te.mobileTextContent, this.$container),
            ...
            this.on("click keyup" + this.mobileSlideshowNamespace, te.indicatorDots, this._onClickIndicatorDot.bind(this)),
            this.on("click keyup" + this.mobileSlideshowNamespace, te.previousButton, this._previousSlideMobile.bind(this)),
            this.on("click keyup" + this.mobileSlideshowNamespace, te.nextButton, this._nextSlideMobile.bind(this)),
            ...
            this.$button.first().addClass(ee.buttonActive),
            B.promiseStylesheet().then(function() {
        ...
        _previousSlideMobile: function(e) {
            "click" === e.type && t(e.target).addClass(ee.navigationNoFocus),
        ...
        _setSlideMobile: function(t) {
            ...
            0 === this.currentMobileSlide && this.$navigationButtons.filter(te.previousButton).attr("disabled", !0),
            this.currentMobileSlide === this.totalSlides - 1 && this.$navigationButtons.not(te.previousButton).attr("disabled", !0),
        ...
        _setActiveStates: function(e) {
            this.$slide = this.$slide || t(te.slide, this.$container),
            this.$button = this.$button || t(te.button, this.$container),
            this.$dot = this.$dot || t(te.indicatorDots, this.$container);
            var i = this.$slide.eq(this.currentMobileSlide)
              , n = this.$slide.eq(e);
            n.addClass(ee.slideActive).attr("aria-hidden", !1),
            i.addClass(ee.slideActiveTransitioning),
            B.promiseTransitionEnd(n).then(function() {
                i.removeClass(ee.slideActive).removeClass(ee.slideActiveTransitioning).attr("aria-hidden", !0)
            }),
            this.$button.removeClass(ee.buttonActive),
            this.$button.eq(e).addClass(ee.buttonActive),
            this.$dot.removeClass(ee.dotActive),
            this.$dot.eq(e).addClass(ee.dotActive)
        },
        _setSlideshowA11y: function() {
            this.$labels = this.$labels || this.$button.find(te.label),
            this.$ctaSingleSlide = this.$ctaSingleSlide || this.$button.find(te.ctaSingleSlide),
        ...
        _setSlideA11y: function(e) {
            ...
            this.$ctasMultipleSlides = this.$ctasMultipleSlides || this.$button.find(te.ctaMultipleSlides),
            this.$ctasMultipleSlides && (this.$ctasMultipleSlides.attr("tabindex", "-1"),
            i.hasClass(ee.linkActive) && this.$ctasMultipleSlides.eq(e).attr("tabindex", "0")),
        ...
        _setMobileText: function(t) {
            ...
            if (this.$ctaSingleSlide = this.$ctaSingleSlide || this.$button.find(te.ctaSingleSlide),
    ...
    Q.register("slideshow-section", {
        ...
        _resetSlideshowValues: function() {
            t(ne.slide).removeClass(se.slideActive).first().addClass(se.slideActive),
            t(ne.button).removeClass(se.buttonActive).first().addClass(se.buttonActive)
        },
    ...
    Q.register("video-section", {
        onLoad: function() {
            this.$container = t(this.container),
            this.$container.on("click", oe.loadPlayerButton, this._loadPlayer.bind(this)).on("click", oe.closePlayerButton, this._closePlayer.bind(this)).on("click", oe.bodyOverlay, this._closePlayer.bind(this))
        },
        _loadPlayer: function() {
            var e, i = this.$container, n = t(oe.loadPlayerButton, i), s = t(oe.playerContainer, i), o = this.$container.attr("data-video-type");
            return n.addClass(ae.animateButton),
            ...
            e.then(this._onPlayerLoadReady.bind(this)).catch(this._onPlayerLoadError.bind(this)).always(function() {
                n.removeClass(ae.animateButton)
            })
        },
        ...
        _onPlayerLoadReady: function() {
            t(oe.closePlayerButton, this.$container).show().focus(),
            t(oe.cover, this.$container).prepareTransition().addClass(ae.playerLoaded),
            this.$container.addClass(ae.playerLoaded),
        ...
        _onPlayerLoadError: function(e) {
            this.$container.addClass(ae.playerError),
            t(oe.errorMessage, this.$container).text(e)
        },
        _closeOnEscape: function(e) {
            27 === e.keyCode && (this._closePlayer(),
            t(oe.loadPlayerButton, this.$container).focus())
        },
        _onScroll: function() {
            var e = t(window).scrollTop();
        ...
        _closePlayer: function() {
            t(oe.cover, this.$container).prepareTransition().removeClass(ae.playerLoaded),
            this.$container.removeClass(ae.playerLoaded),
            t(oe.closePlayerButton, this.$container).hide(),
            "function" == typeof this.player.destroy ? this.player.destroy() : "function" == typeof this.player.unload && this.player.unload(),
            t(document).off(this.namespace),
            t(window).off(this.namespace)
        }
    }),
    window.theme.templates = A,
    window.theme.sections = Q,
